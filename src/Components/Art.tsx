...
function Art() {
  ...
  return (
    <section ref={artRef} id="art" className=" min-h-screen relative radial-gradient max-w-7xl mx-auto flex flex-col justify-center items-center">
      ...
      <h2 className="mt-36 will-fade text-[20vw] text-[#434343] font-negra text-center text-nowrap leading-none">The Art</h2>

      <div className="flex justify-between mt-10 w-7xl font-mona">
      ...
      <div className="absolute top-1/2 left-1/2 transform  -translate-x-1/2 -translate-y-1/2 w-[70%] rounded-4xl overflow-hidden">
        <img src={underImg} alt="under-img" className=' maskImg mask-[url(/mask-img.png)] mask-no-repeat mask-center mask-size-[50%]' />
      </div>

      <div className='w-full mb-30'>
        <p className="will-fade font-negra text-[#f7f7f7] text-5xl text-center  mt-32">Sip-Worthy Perfection</p>

        <div className="w-full font-serif text-center fade-in opacity-0 absolute bottom-5 -translate-x-1/2  left-1/2 space-y-5">
          <h3 className="font-semibold text-5xl max-w-4xl mx-auto">Made with Craft, Poured with Passion</h3>
